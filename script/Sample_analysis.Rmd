...
tx2gene<-read.table("~/mydatalocal/tp_ngs_scarabi/data/Transcriptome/txp2gene.tsv")
...
```{r}
txis <- lapply(files, function(f) tximport(files = f, type="salmon", tx2gene=tx2gene))
```
